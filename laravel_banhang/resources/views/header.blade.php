			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i>Lương Tài, Bắc Ninh</a></li>
						<li><a href=""><i class="fa fa-phone"></i>0981459289</a></li>
					</ul>
				</div>
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="cart-item-amount">{{$product['qty']}}*
													@if($product['item']['promotion_price'] == $product['item']['unit_price'])
