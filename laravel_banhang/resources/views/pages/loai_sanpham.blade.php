...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">{{$tenloaisp->name}}</h6>
			</div>
									...
									<div class="col-sm-4">
										...
										@endif
											<div class="single-item-header">
												<a href="chi-tiet-san-pham/{{$sp->id}}"><img height="250px" src="source/image/product/{{$sp->image}}" alt=""></a>
											</div>
											<div class="single-item-body">
												<p class="single-item-title">{{$sp->name}}</p>
												<p class="single-item-price">
													@if($sp->promotion_price == $sp->unit_price)
														<span class="del">{{number_format($sp->unit_price)}} VNĐ</span>
													@else
											...
											<div class="single-item-caption">
												<a class="add-to-cart pull-left" href="get-to-cart/{{$sp->id}}"><i class="fa fa-shopping-cart"></i></a>
